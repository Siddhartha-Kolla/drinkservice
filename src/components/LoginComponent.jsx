...
function LoginComponent() {
  return (
    <div className=" lg:grid lg:min-h-[600px] lg:grid-cols-2 xl:min-h-[800px] overflow-hidden">
      ...
      <div className="hidden bg-muted lg:block lg:max-h-screen">
        <img
          ...
          alt="Image"
          className="object-cover dark:brightness-[0.2] dark:grayscale max-h-full w-full"
        />
      </div>
    </div>
  )
